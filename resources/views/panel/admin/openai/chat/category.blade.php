...
@section('content')
    ...
    <div class="pt-6 page-body">
        <div class="container-xl">
            <div class="mb-2">
                <a @if (env('APP_STATUS') == 'Demo') onclick="return toastr.info('This feature is disabled in Demo version.')" @else href="{{ LaravelLocalization::localizeUrl(route('dashboard.admin.openai.chat.addOrUpdateCategory')) }}" @endif
