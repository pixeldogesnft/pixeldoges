            ...
            <div class="row g-2 items-end justify-between max-md:flex-col max-md:items-start max-md:gap-4">
				...
				<div class="col-auto">
					...
					<ul class="flex items-center list-none m-0 mt-3 p-0 gap-2 lg:justify-end">
						<li>
							<button class="inline-flex w-8 h-8 items-center bg-transparent border-none justify-center rounded-md text-heading -mb-4 hover:!bg-black/5 dark:hover:!bg-white/5" onclick="toggleView('dlist')" title="Lis view">
